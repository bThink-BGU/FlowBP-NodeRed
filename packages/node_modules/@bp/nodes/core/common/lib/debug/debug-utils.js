...
RED.debug = (function() {
    ...
    function init(_config) {
        ...
        var toolbar = $('<div class="red-ui-sidebar-header">'+
            '<span class="button-group"><a id="red-ui-sidebar-debug-debug" class="red-ui-sidebar-header-button" href="#"><i class="fa fa-bug"></i> <span></span></a></span>' +
            '<span class="button-group"><a id="red-ui-sidebar-debug-step" class="red-ui-sidebar-header-button" href="#"><i class="fa fa-arrow-right"></i> <span></span></a></span>' +
        ...
        toolbar.find('#red-ui-sidebar-debug-step').on("click", function (e) {
            sendDebugOperation('step',null, function (result, textStatus, xhr) {
    ...
    function sendDebugOperation(action, body, successCallback) {
        var url = "debug-operations/" + action;
        if (body == null) body = {};
    ...
    function processDebugMessage(o) {
        ...
        debugMessage.find(".red-ui-debug-msg-object-value").html(payload);
