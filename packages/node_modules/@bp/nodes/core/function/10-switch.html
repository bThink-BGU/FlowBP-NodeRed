...
(function() {
    ...
    RED.nodes.registerType('switch', {
        ...
        defaults: {
            name: {value:""},
            property: {value:"", required:true, validate: RED.validators.typedInput("propertyType")},
            ...
            $("#node-input-rule-container").css('min-height','150px').css('min-width','450px').editableList({
                addItem: function(container,i,opt) {
                    ...
                    function createValueField(){
                        return $('<input/>',{class:"node-input-rule-value",type:"text",style:"margin-left: 5px;"}).appendTo(row).typedInput({default:'str',types:['msg','str','num']});
                    }
