...
const nodes = [
  ...
  new Node('click', 'Playwright', {
    fields: [
      new Field('lib', { hidden: true, defaultValue: ['playwright', 'undefinded', 'undefined'], types: ["str","jsonata"] }),
  ...
  new Node('admin login', 'PrestaShop', {
    fields: [
      new Field('lib', { hidden: true, defaultValue: ['prestashop', 'undefinded', 'undefined'], types: ["str","jsonata"] }),
      new Field('page', { types: ["msg", "jsonata", "str"], defaultValue: ['page', 'undefined', 'undefined'] }),
      new Field('username'),
      new Field('password'),
  ...
  new Node('marker', 'core', {
    fields: [
      new Field('data', { types: ["msg", "jsonata", "str"], defaultValue: ['page', 'undefined', 'undefined'] }),
    ],
  ...
  new Node('add to cart', 'PrestaShop', {
    fields: [
      ...
      new Field('like'),
      new Field('price', { types: ['num'] }),

    ], icon: "font-awesome/fa-cart-plus"
  }),


  new Node('remove from cart', 'PrestaShop', {
    fields: [
      new Field('lib', { hidden: true, defaultValue: ['prestashop', 'undefined', 'udefined'], types: ["str","jsonata"] }),
      new Field('page', { types: ["msg", "jsonata", "str"], defaultValue: ['page', 'undefined', 'undefined'] }),
      new Field('product'),
  ...
  new Node('login', 'PrestaShop', {
    fields: [
      new Field('lib', { hidden: false, defaultValue: ['prestashop', 'undefinded'], types: ["msg","jsonata"] }),
      new Field('page', { types: ["msg", "jsonata", "str"], defaultValue: ['page', 'undefined', 'undefined'] }),
      new Field('username'),
      new Field('password'),
    ], icon: "font-awesome/fa-sign-in"
  ...
  // region Webots
  new Node('Move-Forward','Webots',{
    fields:[
      new Field('distance',{ types: ['num']})
    ]
  }),
  new Node('Turn-Left','Webots',{
    fields:[
      new Field('angle (degrees)',{ types: ['num']})
    ]
  }),
  new Node('Turn-Right','Webots',{
    fields:[
      new Field('angle (degrees)',{ types: ['num']})
    ]
  }),
  new Node('Stop','Webots'),
  new Node('Wall-Ahead','Webots',{
    // fields:[
    //   new Field('distance',{ types: ['num']})
    // ]
  }),
