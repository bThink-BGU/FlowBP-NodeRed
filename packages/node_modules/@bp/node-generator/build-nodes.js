...
const nodes = [
  //region Playwright
  new Node('start browser', 'Playwright', {
    fields: [
      new Field('lib', { types: ['select'], options: ['playwright'], defaultValue: ['playwright', 'undefined', 'undefined'] }),
      new Field('url')
    ],
  ...
  new Node('end session', 'PrestaShop', {
    fields: [new Field('session_name')],
  ...
  new Node('add to cart', 'PrestaShop', {
    fields: [
      new Field('session_name', { types: ['select', 'multiSelect'], options: ['Session A', 'Session B'] }),
