...
const nodes = [
  ...
  new Node('click', 'Playwright', {
    fields: [
      new Field('lib', { hidden: true, defaultValue: ['playwright', 'undefinded'], types: ["msg","jsonata"] }),
  ...
  new Node('admin login', 'PrestaShop', {
    fields: [
      new Field('lib', { hidden: true, defaultValue: ['prestashop', 'undefinded'], types: ["msg","jsonata"] }),
      new Field('page', { types: ["msg", "jsonata", "str"], defaultValue: ['page', 'undefined', 'undefined'] }),
      new Field('username'),
      new Field('password'),
