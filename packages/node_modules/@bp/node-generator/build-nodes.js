...
const nodes = [
    //region PrestaShop
    new Node('start session', 'PrestaShop', {fields: [new Field('url')], icon: "font-awesome/fa-plus-square-o"}),
    new Node('end session', 'PrestaShop', {fields: [new Field('session_name')], icon: "font-awesome/fa-minus-square-o"}),
    ...
    new Node('admin change stock', 'PrestaShop', [
      new Field('session_name'),
      new Field('product_id'),
      new Field('stock'),
    ], "font-awesome/fa-th"),
  ...
  //region Hot-Cold
  new Node('hot', 'HotCold', { icon: "font-awesome/fa-fire" }),
  new Node('cold', 'HotCold', { icon: "font-awesome/fa-snowflake-o" }),
  ...
  //endregion
    ...
    //region TicTacToe
    new Node('XWin', 'TicTacToe', {fields: [], icon: "font-awesome/fa-trophy"}),
    new Node('OWin', 'TicTacToe', {fields: [], icon: "font-awesome/fa-trophy"}),
    new Node('Draw', 'TicTacToe', {fields: [], icon: "font-awesome/fa-handshake-o"}),
    new Node('X', 'TicTacToe', {fields: [new Field('i'), new Field('j')], icon: "font-awesome/fa-times"}),
    new Node('O', 'TicTacToe', {fields: [new Field('i'), new Field('j')], icon: "font-awesome/fa-circle-thin"}),
    //endregion
];
