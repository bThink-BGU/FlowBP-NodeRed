...
const nodes = [
  ...
  //region Hot-Cold
  inOutNode('hot', 'HotCold', [], "font-awesome/trophy"),
  inOutNode('cold', 'HotCold', [], "font-awesome/trophy"),
  //endregion

  //region TicTacToe
  inOutNode('XWin', 'TicTacToe', [], "font-awesome/trophy"),
  inOutNode('OWin', 'TicTacToe', [], "font-awesome/trophy"),
  inOutNode('Draw', 'TicTacToe', [], "font-awesome/genderless"),
  inOutNode('X', 'TicTacToe', [field('cell', 'text'),field('number','text')],"font-awesome/close"),
  //endregion
];
