//TODO: fix examples 
//TODO: check execution of the node in select and multi select
//TODO: verify that fields are required in 'request' mode - validate only called for non-empty fields
...
module.exports = function () {
  ...
  class Node {
    ...
    constructor(name, category, params = {
      ...
      if(this.fields.length > 0) {
        this.oneditprepare = this.fields.map(f => f.getJS()).join("\n      ");
        this.oneditprepare += `
      $(".sync-wd").hide();
  ...
  class Field {
    ...
    constructor(label, params = {
      types: ['str', 'msg', 'jsonata'], defaultValue: undefined, options: undefined
    }) {
