module.exports = function () {
   ...
   * @param {string}[type='string'] The type of the field, can be one of the following: text, select
   * @param {string}[defaultValue=''] The default value of the field
   * @param {string[]}[data=] The options for a 'select' field, only used if the type is select
   * @param validation a function that can be used to validate the value of the property
