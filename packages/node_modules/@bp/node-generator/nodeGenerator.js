module.exports = function () {
  ...
  function InOutNode(
    ...
    let node = {
      ...
      category: category,
      sanitizedName: sanitizeCamelCase(name),
      help: help,
      color: color,
      icon: icon,
      label: 'function () {\n' +
        '      updateColor(this.eventType, this.id);\n' +
        '      return this.name || "' + sanitizeTitleCase(name) + '";\n' +
        '    }',
      paletteLabel: sanitizeTitleCase(name),
      numInput: numInput,
  ...
  function sanitizeTitleCase(str) {
   ...
   * @param {string[]}[type=['string','jsonata']] The type of the field, can be one of the following: str, num, bool, date, json, msg, select, multiSelect. It can also be an array of types, in which case the field will accept any of the types in the array, except for select and multiSelect.
   ...
   */
  class Field {
    constructor(label, types = ['str', 'jsonata'], defaultValue = undefined, options = undefined, validation = undefined, required = false) {
      this.label = sanitizeTitleCase(label);
