...
module.exports = {
    ...
    paletteCategories: ['subflows', 'core', 'function', 'sequence'],
    // paletteCategories: ['BP'],
    ...
    editorTheme: {
        ...
        header: {
            title: "BPFlow",
            image: path.join(__dirname, 'resources', 'logo.png'), // or null to remove image
            url: "https://github.com/bThink-BGU/FlowBP-NodeRed" // optional url to make the header text/image a link to this url
        },
        /*deployButton: {
            type:"simple",
            label:"Save",
