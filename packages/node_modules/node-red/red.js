...
if (parsedArgs.settings) {
    ...
    if (fs.existsSync(path.join(process.env.NODE_RED_HOME,".config.json"))) {
    ...
    } else if (process.env.HOMEPATH && fs.existsSync(path.join(process.env.HOMEPATH,".flowbp",".config.json"))) {
        // Consider compatibility for older versions
        settingsFile = path.join(process.env.HOMEPATH,".flowbp","settings.js");
    } else {
        ...
        var userDir = parsedArgs.userDir || path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH,".flowbp");
        var userSettingsFile = path.join(userDir,"settings.js");
        if (fs.existsSync(userSettingsFile)) {
            // $HOME/.flowbp/settings.js exists
