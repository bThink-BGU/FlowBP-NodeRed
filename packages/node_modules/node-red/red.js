...
parsedArgs.userDir= path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH,".bp");
if (parsedArgs.settings) {
    ...
    } else if (process.env.HOMEPATH && fs.existsSync(path.join(process.env.HOMEPATH,".bp",".config.json"))) {
        // Consider compatibility for older versions
        settingsFile = path.join(process.env.HOMEPATH,".bp","settings.js");
    } else {
        var userDir = parsedArgs.userDir || path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH,".bp");
...
httpsPromise.then(function(startupHttps) {
    ...
    engineAdapter = require("@bp/engine-adapter")(RED);
    engineAdapter.init();
